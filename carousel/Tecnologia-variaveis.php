<html lang="en">
    <head>
        ...
        <title>Tecnologias variáveis</title>
...
<link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <header>
      ...
      <br>
      <jujuju><h2>Tecnologias variáveis</h2></jujuju>
      <hr>
      <jujuju><h5>inserir um novo produto</h5></jujuju>
      <br>
      <h6>
      <form action="inserirtv.php" method="post">
      ...
      <table border="1" class="table table-dark table-striped">
        ...
        while ($tecnologias_variaveis = $resultado->fetch_assoc()) {
            echo "<tr>
              <td>{$tecnologias_variaveis['idtecnologias_variaveis']}</td>
              <td><img src='{$tecnologias_variaveis['imagem']}'></td>
              <td>{$tecnologias_variaveis['nome']}</td>
              <td>{$tecnologias_variaveis['preco']}</td>
            </tr>";
          }
        ?>
      </table>
