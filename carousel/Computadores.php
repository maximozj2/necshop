...
<link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <header>
      ...
      <br>
      <jujuju><h2>Computadores</h2></jujuju>
      <hr>
      <jujuju><h5>inserir um novo produto</h5></jujuju>
      <br>
      <h6>
      <form action="inserirco.php" method="post">
      ...
      <table border="1" class="table table-dark table-striped">
        ...
        while ($computadores = $resultado->fetch_assoc()) {
            echo "<tr>
              <td>{$computadores['idcomputadores']}</td>
              <td><img src='{$computadores['imagem']}'></td>
              <td>{$computadores['nome']}</td>
              <td>{$computadores['preco']}</td>
            </tr>";
          }
        ?>
      </table>
